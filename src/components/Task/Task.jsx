    ...
    return (
        ...
        >
            ...
            <div className={style.wrapper}
                ref={wrapper}
                style={{ height: Boolean(heightOfDescription) && heightOfDescription + 80 + 'px' }}
            >
                ...
                {isDescriptionVisible && <div className={style.description} ref={descriptionBlock}>{description}</div>}
